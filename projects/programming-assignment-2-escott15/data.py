...
class Duration:
    ...
    """
    add two values of duration, while accounting for not going over 60 seconds; having carry over add to mins
    input: data.Duration
    input data.Duration
    ...
    def __add__ (self: "Duration", other: "Duration")-> "Duration":
        ...
        self.seconds += other.seconds
        temp = divmod(self.seconds, 60)
        self.minutes += temp[0]
        self.seconds = temp[1]
        return Duration(self.minutes, self.seconds)
