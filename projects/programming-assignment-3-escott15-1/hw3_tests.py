...
class TestCases(unittest.TestCase):
    ...
    def test_population1(self):
        result = hw3.population_totals(full_data)
        expected = 318857056
        self.assertEqual(result, expected)
    def test_population2(self):
        expected = 655813
        result = hw3.population_totals(reduced_data)
        self.assertEqual(result, expected)
    ...
    def test_population_by_education1(self):
        expected = 0.0
        result = hw3.population_by_education(reduced_data, 'bachleors degree or higher')
        self.assertEqual(result, expected)
    ...
    def test_population_by_ethnicity2(self):
        ...
        self.assertEqual(result, expected)
    def test_population_by_ethnicity3(self):
        expected = 2520484.4
        result = hw3.population_by_ethnicity(reduced_data, "Black Alone")
        self.assertEqual(result, expected)

    # test population_below_poverty_level
    def test_population_below_poverty_level1(self):
        expected = 10771171.4
        result = hw3.population_by_poverty_level(reduced_data)
        self.assertEqual(result, expected)
    def test_population_by_poverty_level(self):
        expected = 4899648847.400001
        result = hw3.population_by_poverty_level(full_data)
        self.assertEqual(result, expected)
    # Part 4
    ...
    def test_education_greater_than1(self):
        ...
        result = hw3.education_greater_than(reduced_data, "Bachelor's Degree or Higher", 30.0)
        self.assertEqual(result, expected)
    def test_education_greater_than2(self):
        ...
        result = hw3.education_greater_than(reduced_data, 'High School or Higher', 90.0)
        self.assertEqual(result, expected)
    ...
    def test_education_less_than2(self):
        ...
        result = hw3.education_less_than(reduced_data, "High School or Higher", 85.0)
        self.assertEqual(expected, result)
